 ...
 : stars_count(0)
{
	...
	star_pos.reserve(2000);
	std::vector<colorf> star_col;
	star_col.reserve(2000);
	...
	star_colors.init_data(star_col.size() * sizeof(colorf), &star_col[0], GL_STATIC_DRAW);
}
