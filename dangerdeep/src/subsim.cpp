...
int mymain(list<string>& args)
{
	...
	mycfg.register_key(key_names[KEY_THROTTLE_SLOW].name, SDLK_1, 0, 0, 0);
	mycfg.register_key(key_names[KEY_THROTTLE_HALF].name, SDLK_2, 0, 0, 0);
	mycfg.register_key(key_names[KEY_THROTTLE_FULL].name, SDLK_3, 0, 0, 0);
	mycfg.register_key(key_names[KEY_THROTTLE_FLANK].name, SDLK_4, 0, 0, 0);
	mycfg.register_key(key_names[KEY_THROTTLE_STOP].name, SDLK_5, 0, 0, 0);
	mycfg.register_key(key_names[KEY_THROTTLE_REVERSE].name, SDLK_6, 0, 0, 0);
	...
	mycfg.register_key(key_names[KEY_TIME_SCALE_UP].name, SDLK_F11, 0, 0, 0);
