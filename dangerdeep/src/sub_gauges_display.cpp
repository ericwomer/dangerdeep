...
{
	controlscreen_normallight.reset(new image(get_image_dir() + "controlscreen_daylight.png"));
	controlscreen_nightlight.reset(new image(get_image_dir() + "red_controlscreen_rev.0.99_b21_base.png"));
