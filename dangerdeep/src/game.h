...
protected:
	...
	list<sink_record> sunken_ships;	// [SAVE]
	...
	vector<network_connection*> clientcons;	// [SAVE] later!
...
public:
	...
	// fixme: plan and document a save game structure!!!!! 2005/11/24
