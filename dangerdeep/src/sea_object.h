...
public:
    ...
    inline static double kts2ms(const double& knots) { return knots*0.514444444f; }
    inline static double ms2kts(const double& meters) { return meters*1.943844494f; }
    inline static double kmh2ms(const double& kmh) { return kmh*0.277777777f; }
...
public:
    ...
    virtual convoy* get_convoi_ptr () { return 0; }
