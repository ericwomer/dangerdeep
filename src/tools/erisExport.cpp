...
struct v_unite {
    ...
    bool operator<(const v_unite &o) const {
        return (idx_vertex != o.idx_vertex) ? (idx_vertex < o.idx_vertex) : ((idx_normal != o.idx_normal) ? (idx_normal < o.idx_normal) : ((idx_texcoord != o.idx_texcoord) ? (idx_texcoord < o.idx_texcoord) : false));
    }
    bool operator==(const v_unite &o) const {
