...
sub_recogmanual_display::sub_recogmanual_display(user_interface &ui_) : user_display(ui_), page(0), btn_left(82, 681, 11, 31, -1, page, "", "BG_btn_left.png"), btn_right(931, 681, 11, 31, 1, page, "", "BG_btn_right.png") {
}
