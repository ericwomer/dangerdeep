...
class vector3t {
  public:
    ...
    template <class E>
    vector3t(const vector3t<E> &other) : x(D(other.x)), y(D(other.y)), z(D(other.z)) {}
    ...
    D determinant(const vector3t<D> &b, const vector3t<D> &c) const {
        return x * b.y * c.z + b.x * c.y * z + c.x * y * b.z - x * c.y * b.z - b.x * y * c.z - c.x * b.y * z;
    }
};

template <class D2>
inline vector3t<D2> operator*(const D2 &scalar, const vector3t<D2> &v) { return v * scalar; }
...
bool vector3t<D>::solve(const vector3t<D> &o1, const vector3t<D> &o2, const vector3t<D> &o3, D &s1, D &s2, D &s3) const {
    ...
    s1 = ((o2.y * o3.z - o2.z * o3.y) * x + (o2.z * o3.x - o2.x * o3.z) * y + (o2.x * o3.y - o2.y * o3.x) * z) / det;

    s2 = ((o1.z * o3.y - o1.y * o3.z) * x + (o1.x * o3.z - o1.z * o3.x) * y + (o1.y * o3.x - o1.x * o3.y) * z) / det;

    s3 = ((o1.y * o2.z - o1.z * o2.y) * x + (o1.z * o2.x - o1.x * o2.z) * y + (o1.x * o2.y - o1.y * o2.x) * z) / det;
    return true;
}
