...
JsonObjectWriter::JsonObjectWriter(JsonObjectWriter &&source) : m_os{source.m_os},
...
JsonArrayWriter::JsonArrayWriter(JsonArrayWriter &&source) : m_os{source.m_os},
                                                             m_indent_level{source.m_indent_level},
                                                             m_should_comma{source.m_should_comma},
                                                             m_active{source.m_active} {
    source.m_active = false;
