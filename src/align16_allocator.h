...
template <typename _Tp>
inline bool operator==(const align16_allocator<_Tp> &, const align16_allocator<_Tp> &) { return true; }

template <typename _Tp>
inline bool operator!=(const align16_allocator<_Tp> &, const align16_allocator<_Tp> &) { return false; }
