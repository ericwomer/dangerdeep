...
int tests::main() {
    ...
    if (0 == do_gl_tests()) {
        cout << endl
             << BAD << "Not all tests returned successful. Dangerdeep might not run well or at all on your hardware! Problems include:" << endl;
        {
        ...
        cout << endl
             << GOOD << "No problems were found. You should have no problems running Dangerdeep." << endl;
    }
