...
void sea_object::load(const xml_elem &parent) {
    ...
    if (specfilename != specfilename2)
        throw error(string("stored specfilename does not match, type=") + specfilename2 + string(", but read ") + specfilename + string(" from spec file"));
